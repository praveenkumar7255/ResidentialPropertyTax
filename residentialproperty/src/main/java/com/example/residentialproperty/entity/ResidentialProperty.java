...
public class ResidentialProperty {
    ...
    @Column
    @NotNull(message="Zone should not be null")
    ...
    @Column
    @NotNull(message="Constructed Year should not be null")
    @Size(min=4,max=4,message="Cnstructed Year must be exactly 4 Digits")
    public Integer constructedYear;

    @Column
    @NotNull(message="Built Up Area should not be null")
